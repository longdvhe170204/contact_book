...
public class SampleDataLoader {
    ...
    CommandLineRunner runner(UserRepository userRepository,
        ...
        return args -> {
            ...
            ensureUsers(userRepository, studentRole, teacherRole, adminRole, passwordEncoder);
    ...
    private void ensureUsers(
        ...
        ensureUser(userRepository, createAdmin("Admin Hệ Thống", "0999999999", "admin@fschool.edu.vn", adminRole), adminRole, passwordEncoder);
